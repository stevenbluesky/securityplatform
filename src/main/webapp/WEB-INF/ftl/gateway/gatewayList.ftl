...
<#--新增，启用，停用按钮-->
			...
			<button style="float: right;" type="button" id='startGateway' class='btn btn-default'
           	...
           	<button style="float: right;" type="button" class="btn btn-default"
                    onclick="window.location.href='../gateway/typeGatewayInfo'"><@spring.message code="label.entering"/></button>
	...
	<table id="table" data-toggle="table">
        ...
        <tr>
            ...
            <th data-field=""><@spring.message code="label.area"/></th>
            <th data-field=""><@spring.message code="label.serviceprovider"/></th>
            <th data-field=""><@spring.message code="label.installerorg"/></th>
            <th data-field=""><@spring.message code="label.installer"/></th>
            <th data-field=""><@spring.message code="label.user"/></th>
